...
## Efforts for Safe Work Environment (editied in 8/23)
...
* **Non-zero-sum interdisciplinary research**: I view interdisciplinary research as an opportunity for academic fields to learn from and strengthen one another, rather than as a hierarchy or zero-sum competition among them<br>
<br>
...
Additional introduction: https://docs.google.com/document/d/17PhUvuFlltDCgrPV4H4uDCECOa0S8N2MJvmCePTY-IM/edit?usp=drive_link
<!-- * I will not erase contribution of other workers that is already plannded to include, and I expect the same to others as well. If it happens and there are continous rejections after several direct conversations,  -->
